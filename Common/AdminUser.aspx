<%@ Page Title="" Language="C#" Async="true" MasterPageFile="~/Boating/Boating.master" AutoEventWireup="true" CodeFile="~/Common/AdminUser.aspx.cs" Inherits="AdminUser" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
            ...
            <div class="form-body">
                <h5 class="pghr">Admin User <span style="float: right;">
            ...
            <asp:HiddenField runat="server" ID="hfQuerytype" />

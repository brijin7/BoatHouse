...
public partial class SadminUser : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                response = client.PostAsJsonAsync("EmpMstr", EmpMstr).Result;
    ...
    protected void txtZipCode_TextChanged(object sender, EventArgs e)
    {
        try
        {
            string sPassword = txtEmpPassword.Text;
            ...
            using (var client = new HttpClient())
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (dtExists.Rows.Count > 0)
                    {
                        ...
                        ddlEmpDesignation.DataValueField = "ConfigId";
                        ddlEmpDesignation.DataTextField = "ConfigName";
            ...
            using (var client = new HttpClient())
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (dtExists.Rows.Count > 0)
                    {
                        ...
                        {
                            gvmstrEmployee.DataSource = dtExists.AsEnumerable()
                                                        .Where(x => x.Field<Int64>("UserId") != 1001)
                                                        .CopyToDataTable();
                            gvmstrEmployee.DataBind();
                        }

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IndividualSmartTripSheetWeb.aspx.cs" Inherits="IndividualSmartTripSheetWeb" %>
    ...
    <script type="text/javascript">
        function HideLabelRower() {
            ...
            setTimeout(function () {
                ...
                document.getElementById("<%=txtStartDetails.ClientID %>").style.display = "none";
                document.getElementById("<%=txtBoatDetails.ClientID %>").style.display = "inline-block";
                var txtStart = document.getElementById('<%=txtBoatDetails.ClientID %>');
                txtStart.focus();
            }, seconds * 2000);
        };
        function HideLabelRowerEnd() {
            var seconds = 5;
            setTimeout(function () {
                setTimeout(HideModalPopup, 3000);
    ...
    <form id="bdycolor" runat="server">
        ...
        <div class="row" id="divFullPage" runat="server" style="width: 100%">
            ...
            <div class="col-md-6 col-sm-6 " style="text-align: center;">
                <h2 class="sp3" style="padding-top: 0.5rem; text-align: center; padding-left: -1.5rem; display: inline; font-size: 25px;">Individual Trip Sheet </h2>
                <asp:Button ID="BackToTripSheet" runat="server" CssClass="btn btn-primary" Width="90px" Height="43px" Font-Bold="true" Style="margin-top: -16px; margin-left: -7px"
                    OnClientClick="showHourGlass();" OnClick="BackToTripSheet_Click" Text="<<Back" Visible="true" />
            </div>
            <div class="col-md-3 col-sm-3">
        ...
        <div class="row" style="text-align: center; display: inline-block; width: 100%; padding-top: 1rem;">
            <div class="col-xs-12">
                <asp:TextBox ID="txtBoatDetails" runat="server" CssClass="BarCodeTextBoat"
                    placeholder="Scan Boat" Font-Bold="true" AutoComplete="off"
                    Font-Size="40px" AutoPostBack="true" OnTextChanged="txtBoatDetails_TextChanged" Style="display: inline-block"></asp:TextBox>
            </div>
            <div class="col-xs-12">
                <asp:TextBox ID="txtStartDetails" runat="server" CssClass="BarCodeTextStart"
                    ...
                    Font-Size="40px" AutoPostBack="true" OnTextChanged="txtStartDetails_TextChanged" Style="display: none"></asp:TextBox>
            </div>
            <div class="col-xs-12">
                <asp:TextBox ID="txtEndDetails" runat="server" CssClass="BarCodeTextStart"
                    placeholder="Scan Ticket QRCode" Font-Bold="true" AutoComplete="off"
                    Font-Size="40px" AutoPostBack="true" OnTextChanged="txtEndDetails_TextChanged" Style="display: none"></asp:TextBox>
            </div>
            <div class="col-xs-12">
            ...
            <%-- <div class="col-xs-12">
                <asp:TextBox ID="txtRowerEndDetails" runat="server" CssClass="BarCodeTextRower"
                    placeholder="Scan Rower QRCode" Font-Bold="true" AutoComplete="off"
                    Font-Size="40px" AutoPostBack="true" OnTextChanged="txtRowerEndDetails_TextChanged" Style="display: none"></asp:TextBox>
            </div>--%>
        </div>
            ...
            <div class="table-responsive">
                <asp:GridView ID="GvStartedList" runat="server" CssClass="gvCustom" Width="100%"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Boat Seater" HeaderStyle-CssClass="grdHead" Visible="false">
                            <ItemTemplate>
                ...
                <asp:GridView ID="gvTripSheetSettelementEnd" runat="server" CssClass="gvCustom" Width="100%"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Travelled Minutes" HeaderStyle-CssClass="grdHead">
                            <ItemTemplate>
                                <asp:Label ID="lblTraveledMins" runat="server" Text='<%# Eval("TravelledMinutes") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" Font-Bold="true" Font-Size="18px" />
                        </asp:TemplateField>
                    </Columns>
            ...
            <asp:Panel ID="pnlDrag3" runat="server" CssClass="drag">
                <div class="modal-content" style="width: 700px; height: 230px;">
                    <div class="modal-body" style="text-align: center; padding-top: 3rem;">
                        <asp:Label ID="lblBoatReponse" runat="server" Font-Bold="true" ForeColor="#5e18b5" Font-Size="35px"></asp:Label>
                        <asp:Label ID="lblStartResponse" runat="server" Font-Bold="true" ForeColor="#5e18b5" Font-Size="35px" visble="false"></asp:Label>
        ...
        <asp:HiddenField ID="hfBarcodeBoatCount" runat="server" />
        <asp:HiddenField ID="hfActualBoatId" runat="server" />
        <asp:HiddenField ID="hfBookingId" runat="server" />
        <asp:HiddenField ID="hfBoatRefNo" runat="server" />

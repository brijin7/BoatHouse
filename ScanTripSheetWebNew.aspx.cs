...
public partial class ScanTripSheetWebNew : System.Web.UI.Page
{
	...
	protected void Page_Load(object sender, EventArgs e)
    {
		...
		try
		{
			if (!IsPostBack)
			{
				...
				divTripStarted.Style.Add("display", "Block");
				divGridStart.Style.Add("display", "Block");
    ...
    public void BindEndedTripList(string RowerId)
    {
                    ...
                    if (StatusCode == 1)
                    {
                        ...
                        try
                        {
                            ...
                            if (modifiedDatetime > DateTime.Parse(Time))
                            {
                                ...
                                //BindStartedTripList();
                                //BindEndedTripList(RowerId.ToString().Trim());
                                return;
                            }

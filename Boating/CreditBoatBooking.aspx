<%@ Page Title="" Language="C#" MasterPageFile="~/Boating/Boating.master" AutoEventWireup="true" CodeFile="CreditBoatBooking.aspx.cs" Inherits="Boating_CreditBoatBooking" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel" UpdateMode="Conditional">
        <ContentTemplate>
            <div class="form-body" runat="server" visible="false" id="divBookedShow">
                <div class="row" runat="server" visible="false" id="divShow">
                    <div class="col-sm-12 col-md-12 text-center">
                        <h5 class="pghr" style="text-align: center; font-size: 25px; display: inline;">Credit Boat Booking  </h5>
                ...
                <div runat="server" id="divEntry" style="width: 100%">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 text-center">
                            <h5 class="pghr" style="text-align: center; font-size: 20px; display: inline;">Credit Boat Booking </h5>
                        </div>
                        ...
                        <div class="col-sm-7 col-xs-12" style="margin-top: 10px">
                            <div style="padding-bottom: 30px;">
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    <div>
                                        <asp:Button ID="BackToBooking" runat="server" CssClass="btn btn-primary" Width="151px" Height="50px" Font-Bold="true" Style="margin-left: 50px;" OnClick="BackToBooking_Click" Text="<< Back To Booking" Visible="true" />
                                    </div>
                                </div>

                                <div class="row input-group-prepend" style="display: none">
                                    <div class="d-flex justify-content-start" style="padding-left: 15px;">
                                        <asp:Button runat="server" ID="btnNor" OnClick="btnNor_Click" Text="Normal Boat" CssClass="buttonNor block" />
                                    </div>
                                    <div class="d-flex justify-content-center">
                                        <asp:Button runat="server" ID="btnPre" OnClick="btnPre_Click" Text="Premium Boat" CssClass="buttonPre block" Visible="false" />
                                        <br />
                            ...
                            <div class="row m-0 pt-4 FinalSummary">
                                <div class="col-sm-12 p-0">
                                    <asp:GridView ID="gvBoatdtl" runat="server" CssClass="CustomGrid table table-bordered table-condenced grdTextAlign"
                                        AutoGenerateColumns="False" DataKeyNames="UniqueId,BoatType,BoatTypeId,SeaterType,SeaterTypeId,BoatCount,BoatTotalCharge,BoatMinCharge,RowerMinCharge,BoatTaxCharge,DepositType,Deposit,BoatMinTime">
                                        <Columns>
                                ...
                                <div class="col-sm-12 col-xs-12" style="padding: 15px 0px 0px 0px;">
                                    <div class="row m-0 p-0" runat="server" id="divBooking" visible="false">
                                        ...
                                        <div class="col-sm-6 col-xs-12 text-center" style="padding: 0px 0px 0px 30px;">
            ...
            <asp:Panel ID="pnlUserCounttl" runat="server" CssClass="Msg" Style="display: none; min-height: 350px; max-height: 620px; width: 800px; margin-top: 30px;">
                <asp:Panel ID="Panel3" runat="server" CssClass="drag">
                    <div class="modal-content" style="width: 750px; max-height: 600px; min-height: 300px">
                        <div class="modal-header">
                            <h5 class="modal-title">Credit Boat Booked Details
                            ...
                            <div class="table-responsive">
                                ...
                                <asp:GridView ID="gvUserCountTotal" runat="server" AllowPaging="True" CssClass="table table-bordered table-condenced CustomGrid" ShowFooter="true"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Booking Pin" HeaderStyle-CssClass="grdHead">
                                            <ItemTemplate>
                                                <asp:Label ID="lblBookedPin" runat="server" Text='<%# Bind("BookedPin") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:TemplateField>
            ...
            <div style="margin-top: 18%; display: block;" runat="server">
                <asp:CheckBox ID="ChkAvailBoat" Text="Boat Available List" class="SlideCheck" runat="server" OnCheckedChanged="ChkAvailBoat_CheckedChanged" AutoPostBack="true" />

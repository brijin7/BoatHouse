<%@ Page Title="" Async="true" Language="C#" MasterPageFile="~/Boating/Boating.master" AutoEventWireup="true" CodeFile="~/Boating/BoatMaterialConsumption.aspx.cs" Inherits="BoatMaterialConsumption" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="form-body col-sm-12 col-xs-12">
        <h5 class="pghr">Boat Consumption <span style="float: right;">
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <div class="row">
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label runat="server" id="Label1"><i class="fas fa-list"></i>Consumption Id</label>
                                    <asp:TextBox ID="txtConsumptionId" runat="server" CssClass="form-control inputboxstyle" AutoComplete="off" onkeypress="return LettersWithSpaceOnly(event);"
                            ...
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label runat="server" id="Label2"><i class="fa fa-calendar" aria-hidden="true"></i>Consumption Date <span class="spStar">*</span></label>
                                    <asp:TextBox ID="txtConsumptionDate" runat="server" CssClass="form-control datepicker" AutoComplete="off"
                                        MaxLength="50" Font-Size="14px" TabIndex="2">
                                    </asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtConsumptionDate"
                                        ValidationGroup="OfferMaster" SetFocusOnError="True" CssClass="vError">Select Consumption Date</asp:RequiredFieldValidator>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label runat="server" id="Label3"><i class="fas fa-list"></i>Boat Type <span class="spStar">*</span></label>
                                        <asp:DropDownList ID="ddlBoatType" CssClass="form-control inputboxstyle" runat="server" AutoPostBack="true" TabIndex="3">
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="ddlBoatType"
                                            ValidationGroup="OfferMaster" InitialValue="0" SetFocusOnError="True" CssClass="vError">Select Boat Type</asp:RequiredFieldValidator>
                                    </div>
                            ...
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label runat="server" id="Label4">
                                        <i class="fas fa-list"></i>Boat Seater <span class="spStar">*</span>
                                    </label>
                                    <asp:DropDownList ID="ddlBoatSeater" CssClass="form-control inputboxstyle" runat="server" AutoPostBack="true" TabIndex="4">
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ddlBoatSeater"
                                        ValidationGroup="OfferMaster" InitialValue="0" SetFocusOnError="True" CssClass="vError">Select Boat Seater</asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label runat="server" id="Label5"><i class="fas fa-list"></i>Item <span class="spStar">*</span></label>
                                    <asp:DropDownList ID="ddlItem" CssClass="form-control inputboxstyle" runat="server" TabIndex="5">
                                    </asp:DropDownList>
                            ...
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label runat="server" id="Label6"><i class="fas fa-list"></i>Quantity Per Trip <span class="spStar">*</span></label>
                                    <asp:TextBox ID="txtItemQty" runat="server" CssClass="form-control" AutoComplete="off" onkeypress="return isNumber(event);"
                                        MaxLength="7" Font-Size="14px" TabIndex="6">
                                    </asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtItemQty"
                                        ValidationGroup="OfferMaster" SetFocusOnError="True" CssClass="vError">Enter Quantity Per Trip </asp:RequiredFieldValidator>
                        ...
                        <div id="divAddGrid" runat="server" visible="false">
                            <div class="table-responsive">
                                <asp:GridView ID="gvAddGrid" runat="server" AllowPaging="True" OnRowDataBound="gvAddGrid_RowDataBound"
                                    ...
                                    DataKeyNames="ConsumptionId" PageSize="25000">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Consumption Id" HeaderStyle-CssClass="grdHead" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblConsumptionId" runat="server" Text='<%# Bind("ConsumptionId") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Quantity Per Trip" HeaderStyle-CssClass="grdHead">
                                            <ItemTemplate>
                                                <asp:Label ID="lblItemQtyPerTrip" runat="server" Text='<%# Bind("ItemQtyPerTrip") %>'></asp:Label>
                                            </ItemTemplate>
        ...
        <div id="divgrid" runat="server">
            <div class="table-responsive">
                <asp:GridView ID="gvBoatConsumptionDetails" runat="server" AllowPaging="True"
                    CssClass="gvv display table table-bordered table-condenced" AutoGenerateColumns="False" OnRowDataBound="gvBoatConsumptionDetails_RowDataBound"
                    DataKeyNames="ConsumptionId" PageSize="25000">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Consumption Date" HeaderStyle-CssClass="grdHead">
                            <ItemTemplate>
                                <asp:Label ID="lblConsumptionDate" runat="server" Text='<%# Bind("ConsumptionDate") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
    ...
    <asp:Panel ID="pnlMaterialItem" runat="server" CssClass="Msg" Style="display: none; height: 750px; width: 450px; margin-top: 180px;">
        <asp:Panel ID="pnlDrag3" runat="server" CssClass="drag">
            <div class="modal-content" style="width: 750px">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Material Item Details</h5>
                ...
                <div class="modal-body">
                    ...
                    <asp:GridView ID="gvConsumptionItemDetails" runat="server" AllowPaging="True"

<%@ Page Title="" Language="C#" MasterPageFile="~/Boating/Boating.master" AutoEventWireup="true"
    CodeFile="BoatBookingFinal.aspx.cs" Inherits="Boating_BoatBookingFinal" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <style type="text/css">
        ...
        .buttonaddl {
            background-color: #6babffd9; /*#4f94efd9;*/
            border-radius: 10px;
            border: 1px solid #18ab29;
            display: inline-block;
            cursor: pointer;
        ...
        .buttonInd {
            background-color: #fd5affad; /*#c900ccad;*/
            border-radius: 10px;
            border: 1px solid #18ab29;
            display: inline-block;
            cursor: pointer;
            ...
            .buttonNor:hover, .buttonPre:hover, .buttonaddl:hover, .buttonOth:hover, .buttonInd:hover {
                background-color: #203e9e;
                color: white;
            }


            .buttonNor:active, .buttonPre:active, .buttonaddl:active, .buttonOth:active, .buttonInd:active {
                position: relative;
                top: 1px;
            }
            ...
            <div class="form-body1">
                <div class="row" runat="server" visible="false" id="divShow">
                    <div class="col-sm-12 col-md-12 text-center">
                        <h5 class="pghr" style="text-align: center; font-size: 25px; display: inline;">Boat Booking  </h5>
                ...
                <div runat="server" id="divEntry" style="width: 100%">
                     ...
                     <div class="row">
                         <div class="col-md-2 col-sm-12">
                             <h5 id="Time" style="display: inline; color: black;"></h5>
                         </div>

                         <div class="col-md-2 col-sm-12">
                             <h5 class="pghr" style="text-align: center; font-size: 24px; display: inline;">Boat Booking  </h5>
                         </div>

                         <div class="col-md-5 col-sm-12 text-center">
                             <a href="#" alt="Bulk Boat Booking" class="tooltipDemo" id="BulkBoatBooking" runat="server">
                                 <asp:CheckBox runat="server" Style="zoom: 1.5;" Width="17px" Height="21px" ID="ChkBulk" onchange="showHourGlass();" OnCheckedChanged="ChkBulk_CheckedChanged" AutoPostBack="true" /><b style="font-size: 19px; color: black;">Bulk</b>
                             </a>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <a href="#" alt="Credit Boat Booking" class="tooltipDemo" id="CreditBoatBooking" runat="server">
                                 <asp:CheckBox runat="server" Style="zoom: 1.5;" Width="17px" Height="21px" ID="ChkCredit" onchange="showHourGlass();" OnCheckedChanged="ChkCredit_CheckedChanged" AutoPostBack="true" /><b style="font-size: 19px; color: black;">Credit</b>
                             </a>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             ...
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <a href="#" alt="Customer GST No." class="tooltipDemo">
                                 <asp:CheckBox runat="server" Style="zoom: 1.5;" Width="17px" Height="21px" ID="chkGSTNo" OnCheckedChanged="chkGSTNo_CheckedChanged" AutoPostBack="true" /><b style="font-size: 18px; color: black;">GST No.</b>&nbsp;&nbsp;
                             </a>
                         </div>
                         <div class="col-md-3 col-sm-12">
                             <h5 id="Date" style="display: inline; overflow: auto; float: right; padding: 0px 10px 0px 20px; color: black;"></h5>
                             <asp:ImageButton ID="imgbtnBookedList" runat="server" Style="float: right" ImageUrl="~/images/Print.svg"
                                 Width="30px" OnClick="imgbtnBookedList_Click" OnClientClick="StopTimer()" ToolTip="Ticket Re-Print" />
                         </div>
                     </div>
                    <hr />
                    ...
                    <ajax:ModalPopupExtender ID="MPEBBpopup" BackgroundCssClass="modalBackground" runat="server" BehaviorID="MPEBBpopup" TargetControlID="hfBBpupup" PopupControlID="PnlBBRevenue">
                            ...
                            <div style="padding-bottom: 20px;">
                                <div class="row input-group-prepend">
                                    <div class="d-flex justify-content-start" style="padding-left: 16px; font-size: 11px;">
                                        <asp:Button runat="server" ID="btnNor" OnClick="btnNor_Click" Text="Normal Per Boat" CssClass="buttonNor block" Visible="false" />
                                    </div>
                                    <div class="d-flex justify-content-center" style="font-size: 11px">
                                        <asp:Button runat="server" ID="btnPre" OnClick="btnPre_Click" Text="Express Per Boat" CssClass="buttonPre block" Visible="false" />
                                        <br />
                                ...
                                <div class="col-sm-12 col-xs-12" style="padding: 15px 0px 0px 0px;">
                                    <div class="row m-0 p-0" runat="server" id="divBooking" visible="false">
                                        <div class="col-sm-4 col-xs-12 p-0 text-center">
                                            <asp:DropDownList ID="ddlPaymentType" CssClass="payMode" runat="server" OnSelectedIndexChanged="ddlPaymentType_SelectedIndexChanged"
                                        ...
                                        <div class="col-sm-12 col-xs-12" runat="server" id="divQrMob" visible="false">
                                            <div class="row" style="padding: 10px 60px 5px 35px;">
                                                <div class="col-sm-6 col-xs-12 text-center" id="divQrMobNoVisible" runat="server" style="padding-top: 6px;">
                                                    <asp:TextBox ID="txtQrMob" runat="server" CssClass="form-control textpin" AutoComplete="Off"
                                                        MaxLength="10" TabIndex="6" Width="170px" Height="50px" placeholder="Mobile No"
                                                        ForeColor="Black" BorderColor="Black" Font-Bold="true" onkeypress="return isNumber(event)">
                                                    </asp:TextBox>
                                                </div>

                                                <div class="col-sm-6 col-xs-12 p-0 text-center" id="divQrStyle" runat="server">
                                                    <asp:Button ID="BtnGenerateQRcode" Visible="false" runat="server" Text="GetQRcode" CausesValidation="false" class="btn btn-success btnFinal" TabIndex="15"
                                            ...
                                            <div class="row" style="padding-top: 10px">
                                                <div class="col-sm-6 col-xs-12 p-0 text-center">
                                                    <asp:TextBox ID="txtAmountPaid" runat="server" CssClass="form-control textpin" AutoComplete="Off"
                                                        MaxLength="5" TabIndex="6" Width="220px" Height="50px" placeholder="Advance Collected"
                    ...
                    <asp:HiddenField runat="server" ID="hfQRCode" />
                    <ajax:ModalPopupExtender
                        ID="MpepnlrsnQR"
                        BackgroundCssClass="modalBackground"
                        runat="server"
                        BehaviorID="MpepnlrsnQr"
                        TargetControlID="hfQRCode"
                        PopupControlID="PanelQRPopUp">
                    </ajax:ModalPopupExtender>
                    <asp:Panel ID="PanelQRPopUp" runat="server" CssClass="Msg" Style="display: none; min-height: 200px; max-height: 500px; width: 500px; margin-top: 30px;">
                        <asp:Panel ID="PanelQR" runat="server" CssClass="drag">
                            <div class="modal-content" style="width: 480px; max-height: 300px; min-height: 150px">
                                <div class="modal-header" style="background-color: #203e9e;">
                                    <asp:Label ID="QRHdr" runat="server" CssClass="QRCodeLabel" Text="Generate Ticket" Font-Bold="true" Font-Size="20px" ForeColor="White"></asp:Label>
                                </div>
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-sm-7">
                                            <asp:Image ID="imgQRCode" runat="server" CssClass="FinalSummary" Width="200px" Height="200px" />
                                        </div>
                                        <div class="col-sm-5 pt-4 mt-5">
                                            <div class="row">
                                                <asp:Button ID="btnGenerateQRTicket" runat="server" Text="Print Ticket" CssClass="btn btn-success" OnClick="btnGenerateQRTicket_Click" />
                                                &nbsp&nbsp&nbsp
                                                <asp:Button ID="btnCloseQRTicket" runat="server" Text="Close" CssClass="btn btn-danger" OnClick="btnCloseQRTicket_Click" />
                                            </div>
                                            <div class="row" style="padding-top: 30px;">
                                                <asp:Label ID="lblStartResponse" CssClass="blink" runat="server" Font-Bold="true" ForeColor="Red" Font-Size="X-Large"></asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <ajax:ModalPopupExtender ID="MpeBillService" BackgroundCssClass="modalBackground" runat="server" BehaviorID="MpeBillService" TargetControlID="HiddenField1" PopupControlID="pnlBillService">
                        </ajax:ModalPopupExtender>
                ...
                <div class="col-xs-12 table-div" runat="server" id="divGridList" visible="false">
                    ...
                    <ajax:ModalPopupExtender ID="Mpepnlrsn" BackgroundCssClass="modalBackground" runat="server" BehaviorID="Mpepnlrsn" TargetControlID="hfreason" PopupControlID="pnlRsn">
                    </ajax:ModalPopupExtender>
                ...
                <ajax:DragPanelExtender ID="DragPanelExtender1" runat="server" TargetControlID="pnlTrip" DragHandleID="Panel1"></ajax:DragPanelExtender>
                <ajax:ModalPopupExtender ID="MpeTrip" runat="server" BackgroundCssClass="modalBackground" BehaviorID="MpeTrip" TargetControlID="HiddenField2" PopupControlID="pnlTrip">
                </ajax:ModalPopupExtender>
                ...
                <ajax:ModalPopupExtender ID="MpeUserCount" BackgroundCssClass="modalBackground" runat="server" BehaviorID="MpeUserCount" TargetControlID="HiddenField3" PopupControlID="pnlUserCounttl">
                </ajax:ModalPopupExtender>
                ...
                <ajax:ModalPopupExtender ID="MpeUpdateSlot" BackgroundCssClass="modalBackground" runat="server" BehaviorID="MpeUpdateSlot" TargetControlID="HiddenField4" PopupControlID="pnlUpdateSlot">
                </ajax:ModalPopupExtender>
                ...
                <ajax:ModalPopupExtender ID="MpepnlPopup" runat="server" BackgroundCssClass="modalBackground" BehaviorID="MpepnlPopup" TargetControlID="HiddenField5" PopupControlID="pnlPopup">
                </ajax:ModalPopupExtender>
                                                ...
                                                <asp:TemplateField ItemStyle-Width="20px">
                                                    <ItemTemplate>
                                                        <a href="JavaScript:divexpandcollapse('div<%# Eval("BoatTypeId") %>');">
                                                            <img id="imgdiv<%# Eval("BoatTypeId") %>" style="width: 15px;" border="0" src="../images/Add.png" alt="" /></a>
                                                    </ItemTemplate>
                ...
                <div id="HourGlass" style="position: fixed; text-align: center; height: 100%; width: 100%; top: 0; right: 0; left: 0; z-index: 9999999; background-color: #0000007d; opacity: 0.8; display: none">
                    <span style="border-width: 0px; position: fixed; padding: 20px; background-color: #FFFFFF; font-size: 30px; left: 40%; top: 40%; border-radius: 50px;">
                        <img src="../images/hourglass.gif" style="width: 100px; height: 100px;" />
                </div>
            </span>
        </ContentTemplate>
        <Triggers>

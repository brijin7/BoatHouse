<%@ Page Title="" Language="C#" MasterPageFile="~/Boating/Boating.master" AutoEventWireup="true" CodeFile="RptPrintAdditionalTicket.aspx.cs" Inherits="Reports_RptPrintAdditionalTicket" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="form-body">
        <h5 class="pghr">Additional Ticket</h5>
        <hr />
        <div class="mydivbrdr">
            <div class="row p-2">

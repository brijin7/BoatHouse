<%@ Page Title="" Language="C#" MasterPageFile="~/Boating/Boating.master" AutoEventWireup="true" CodeFile="RowerList.aspx.cs" Inherits="Reports_BoatHouseReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">

    <div class="form-body">
        <h5 class="pghr">Boat Type Rower List</h5>
        <hr />
        <div class="mydivbrdr">

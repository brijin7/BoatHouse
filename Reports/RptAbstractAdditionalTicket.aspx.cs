...
public partial class Reports_RptAbstractAdditionalTicket : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                BindAdditionalTkt();
                BindAdditionalTktSummary();
                BindBookingAdditionalTkt();
            }
        }
        catch (HttpException)
        {
    ...
    public void BindAdditionalTkt()
    {
        try
        {
            using (var client = new HttpClient())
            {
                ...
                HttpResponseMessage response = client.PostAsJsonAsync("RptAbstractAdditionalTkt", service).Result;
    ...
    public void BindBookingAdditionalTkt()
    {
        try
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                HttpResponseMessage response = client.PostAsJsonAsync("RptAdditionalTkt", BookingOtherServices).Result;
    ...
    public void BindAdditionalTktSummary()

    {
        try
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                HttpResponseMessage response = client.PostAsJsonAsync("RptAdditionalTktSummary", BookingOtherServices).Result;
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (StatusCode == 1)
                    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            GvOtherServiceSummary.FooterRow.Cells[2].Text = "Total";
                            GvOtherServiceSummary.FooterRow.Cells[2].HorizontalAlign = HorizontalAlign.Center;

                            GvOtherServiceSummary.FooterRow.Cells[3].Text = NoOfItems.ToString();
                            GvOtherServiceSummary.FooterRow.Cells[3].HorizontalAlign = HorizontalAlign.Center;

                            //GvOtherServiceSummary.FooterRow.Cells[4].Text = ItemAmount.ToString("N2");
                            //GvOtherServiceSummary.FooterRow.Cells[4].HorizontalAlign = HorizontalAlign.Right;

                            GvOtherServiceSummary.FooterRow.Cells[5].Text = NetAmount.ToString("N2");

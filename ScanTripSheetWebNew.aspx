<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScanTripSheetWebNew.aspx.cs" Inherits="ScanTripSheetWebNew" %>
...
<body onload="StartBox()" onclick="StartBox()" style="height: 1000px; overflow: hidden;">
    ...
    <form id="bdycolor" runat="server">
        ...
        <div class="table-div" id="divTripStarted" runat="server" style="display:none;background-color: white; padding-left: 2rem; width: 100%; text-align: center; padding-right: 2rem;">

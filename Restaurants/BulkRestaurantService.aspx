<%@ Page Title="" Language="C#" MasterPageFile="~/Boating/Boating.master" AutoEventWireup="true" CodeFile="BulkRestaurantService.aspx.cs" Inherits="Restaurants_BulkRestaurantService" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script type="text/javascript">
        function addItem(id) {
            Inactivebutton();
            if (id != null) {
                document.getElementById(id).style.backgroundColor = "#18ab29";
            }
                ...
                $('.btn').click(function () {
                    if (this.innerHTML == 'ADD') {
                        ...
                        if ($('#<%=hfServiceId.ClientID %>').val() == "") {
                            ...
                            document.getElementById("<%=txtNumberPass.ClientID%>").value = "";

                            info("Please, Select Any One Items !!!");
                            return;
                        }

                        if (document.getElementById("<%=txtNumberPass.ClientID%>").value == "") {
                            ...
                            info("Please, Enter No of Items !!!");
                            return;
                        }

                        if (parseInt(document.getElementById("<%=txtNumberPass.ClientID%>").value) > 200) {

                            document.getElementById("<%=txtNumberPass.ClientID%>").value = "";
                            info("Please, Enter Count Less than Or Equal to 200 !!!");
                            return;
                        }

                        $('#<%=hfAdultCount.ClientID %>').val(document.getElementById("<%=txtNumberPass.ClientID%>").value);
                        ...
                        document.getElementById("<%=txtNumberPass.ClientID%>").value = "";
                        $('#<%=hfServiceId.ClientID %>').val("");
                        $('#<%=hfServiceName.ClientID %>').val("");
                        $('#<%=hfServiceTotalAmount.ClientID %>').val("");
                        $('#<%=hfChargePerItem.ClientID %>').val("");
                        $('#<%=hfChargePerItemTax.ClientID %>').val("");
                        $('#<%=hfTaxId.ClientID %>').val("");
                        $('#<%=hfTaxName.ClientID %>').val("");
                        $('#<%=hfCategoryName.ClientID %>').val("");
                        $('#<%=hfAdultCount.ClientID %>').val("");
                    }
            ...
            <div class="form-body m-0">
                <div class="row" runat="server" visible="false" id="divShow">
                    <div class="col-sm-12 col-md-12 text-center">
                        <h5 class="pghr" style="text-align: center; font-size: 25px; display: inline;">Bulk Restaurant Services </h5>
                ...
                <div runat="server" id="divEntry" style="width: 100%">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-12 text-center">
                            <h5 class="pghr" style="text-align: center; font-size: 20px; display: inline;">Bulk Restaurant Services  </h5>
                        </div>
                        <div class="col-md-2 col-sm-12">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <asp:Button ID="BackToBooking" runat="server" CssClass="btn-primary" Width="120px" Height="30px" Font-Bold="true" 
                                OnClick="BackToBooking_Click" Style="cursor: pointer;" Text="<< Back " Visible="true" />
                            <h3 id="Date" style="display: inline; overflow: auto; float: right; padding-left: 20px; color: black; border-radius: 3px;"></h3>
                            ...
                            <div>
                                <div class="col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <a class="input-group-prepend col-sm-12">
                                                <asp:Panel runat="server" ID="pnlTicketCount" Visible="false">
                                                    <label for="Boats" id="lblTickets" style="font-size: 22px;"><i class="fa fa-user" aria-hidden="true"></i>No of Items</label>
                                                    <asp:DropDownList runat="server" ID="dlstTicketsCount" AutoPostBack="true" CssClass="select"
                                                        OnSelectedIndexChanged="dlstTicketsCount_SelectedIndexChanged" Width="100px">
                                                ...
                                                <asp:Panel runat="server" ID="pnlTicketKeypad" Visible="true">
                                                    ...
                                                    <div id="numericInput" class="input-group-prepend" style="width: 400px;">
                                                        <label for="numbox" id="lblnumber" style="font-size: 22px;"><i class="fa fa-user" aria-hidden="true"></i>No of Items</label>
                                                        <div id="numBox"></div>
                                                        <table id="keypad">
                                ...
                                <div class="col-sm-12">
                                    <div style="margin-top: 15px; overflow-x: scroll; max-height: 500px; overflow-x: auto">
                                        <asp:DataList ID="dtlOtherChild" runat="server" OnItemCommand="dtlOtherChild_ItemCommand"
                                            RepeatColumns="4" RepeatDirection="Horizontal" Style="max-width: 100% !important; min-width: 10% !important">
                                            <ItemTemplate>
                                                <div class="dtlBoatType buttonRes" style="width: 175px !important; text-align: center;">
                                                    <%--<div class="rectangle" style="text-align: center; margin-top: 3px" onclick="add('<%# Eval("ServiceId") %>','<%# Eval("ServiceName") %>', '<%# Eval("ServiceTotalAmount") %>', '<%# Eval("AdultCharge") %>',
                                                        '<%# Eval("ChargePerItemTax") %>', '1', '<%# Eval("TaxId") %>', '<%# Eval("TaxName") %>','<%# Eval("CategoryName") %>');">
                                                    ...
                                                    <div id="<%# Eval("ServiceId") %>" class="rectangle" style="text-align: center;"
                                                        onclick="addItem('<%# Eval("ServiceId") %>');add('<%# Eval("ServiceId") %>','<%# Eval("ServiceName") %>', '<%# Eval("ServiceTotalAmount") %>', '<%# Eval("AdultCharge") %>',
                                                    ...
                                                    <div style="display: none;">
                                                        ...
                                                        <asp:Label ID="lblStockEntryMaintenance" runat="server" Text='<%# Eval("StockEntryMaintenance") %>'></asp:Label></b>
                                                ...
                                                <td colspan="2" style="border-top: none;">
                                                    <div class="col-sm-12 input-group-prepend float-right" runat="server" id="divpaymentType" visible="false" style="padding: 0px;">
                                                        ...
                                                        <asp:Button ID="btnOtherBooking" runat="server" Text="Submit" class="btn-primary btnFinal" ValidationGroup="BookingHeader" TabIndex="14"
                                                            OnClick="btnOtherBooking_Click" Width="120px" Font-Bold="True" Style="margin-left: 0px; cursor: pointer" OnClientClick="showLoader();" />
                                                        &nbsp;&nbsp;
                                                        <asp:Button ID="btnCancel" runat="server" Text="Cancel" CausesValidation="false" class="btn-danger btnFinal" TabIndex="15"
                                                            OnClick="btnCancel_Click" Style="margin-left: 0px; cursor: pointer" />
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
                ...
                <div class="col-xs-12 table-div" runat="server" id="divGridList" visible="false">
                    <div class="col-xs-12 table-responsive">
                        ...
                        <div style="text-align: right;">
                            <div id="Search" runat="server" style="padding-bottom: 10px">
                                Search :
                        <asp:TextBox ID="txtSearch" runat="server" Font-Size="16px" OnTextChanged="txtSearch_TextChanged" AutoPostBack="true" AutoComplete="off" Placeholder="Enter Booking Id"></asp:TextBox>
                            </div>
                        ...
                        <asp:Button ID="Next" Visible="true" CssClass="PrevBack btn-color " runat="server" Text="Next →" OnClick="Next_Click" />
                            ...
                            <div style="text-align: left;">
                                <asp:Button ID="backSearch" runat="server" CssClass="PrevBack btn-color" Visible="false" Text="← Previous" Enabled="false" OnClick="backSearch_Click" />
                                &nbsp
                        <asp:Button ID="NextSearch" Visible="false" CssClass="PrevBack btn-color" runat="server" Text="Next →" OnClick="NextSearch_Click" />
                                &nbsp       
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3" style="top: 30px;">
                                            <div class="table-responsive">
                                                <div style="margin-left: auto; margin-right: auto; text-align: center;">
                                                    <asp:Button runat="server" Text="Print" ID="RsnSubmit" OnClick="RsnSubmit_Click" CssClass="btn-primary" ValidationGroup="BoatHouseName" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        ...
        function add(ServiceId, ServiceName, ServiceTotalAmount, ChargePerItem, ChargePerItemTax, AdultCount, TaxId, TaxName, CategoryName, AvailableQty, StockEntryMaintenance) {
          ...
          <%-- // $('#<%=hfAdultCount.ClientID %>').val('#<%=txtNumberPass.ClientID %>');--%>
